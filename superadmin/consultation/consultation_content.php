                    ...
                    <form id="editForm">
                        ...
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="editlatestcheckup_date"
                                    name="latestcheckup_date" required>
                            </div>
                        </div>
                        <script>
                            ...
                            document.getElementById('editlatestcheckup_date').min = tomorrow;
                        </script>
...
<script>
    $(document).ready(function () {
        ...
        $('#addButton').click(function () {
            ...
            var latestcheckup_date = $('#editlatestcheckup_date').val();
            ...
            $.ajax({
                ...
                data: {
                    ...
                    latestcheckup_date: latestcheckup_date,
                    diagnosis: diagnosis,
                    medicine: medicine,
                },
        ...
        $('#tablebod').on('click', '.editbtn', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#editModal #editlatestcheckup_date').val(editGetData.latestcheckup_date);

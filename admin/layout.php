      ...
      <div class="sidebar">
        ...
        <nav class="mt-2" style="height:700px;">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item <?php
            if (
              strpos($_SERVER['REQUEST_URI'], '/brgyv2/admin/report/patients.php') !== false ||
            ...
            ?>">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="../report/patient.php" class="nav-link <?php if ($_SERVER['REQUEST_URI'] === '/brgyv2/admin/report/patient.php')
                    echo 'active'; ?> ">
